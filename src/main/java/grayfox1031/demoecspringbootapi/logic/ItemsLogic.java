...
import grayfox1031.demoecspringbootapi.Dto.ItemListDto;
...
//    private final RestTemplate restTemplate;
    ...
    public ItemListDto getItemList() throws IOException {
        ...
        ItemListDto itemList = mapper.readValue(response, ItemListDto.class);
